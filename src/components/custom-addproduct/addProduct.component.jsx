...
import {  addProductDocumentToCollection } from "../../utils/firebase/firebase";
import { MdOutlineClose } from "react-icons/md";

import { useSelector } from "react-redux";

import { selectProducts } from "../../store/product/product.selector";
import { updateProducts } from "../../store/product/product.action";

const AddCustomProducts = ({ setModal }) => {
  ...
  const onSubmitAction = async (data) => {
    ...
    try {
      await addProductDocumentToCollection({ ...data, price: priceNo });

      updateProducts(products, { ...data, price: priceNo });
    } catch (error) {
